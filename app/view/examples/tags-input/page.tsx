  ...
  <PreviewLocaleProvider>
    ...
    <div className="grid gap-16 sm:grid-cols-2">
      ...
      <section
        ...
        className="flex flex-col gap-5"
      >
        <h2 className="font-medium text-muted-foreground" id="combobox-heading">
          Combobox
        </h2>
        <div className="rounded-3xl bg-muted p-6 sm:p-10">
          <ExampleCombobox />
      ...
      <section
        ...
        className="flex flex-col gap-5"
      >
        <h2 className="font-medium text-muted-foreground" id="max-tags-heading">
          Max Tags
        </h2>
        <div className="rounded-3xl border bg-card p-6 sm:p-10">
          <ExampleMaxTags />
      ...
      <section
        ...
        className="flex flex-col gap-5"
      >
        <h2 className="font-medium text-muted-foreground" id="size-lg-heading">
          Size LG
        </h2>
        <div className="rounded-3xl border bg-card p-6 sm:p-10">
          <ExampleSizeLg />
      ...
      <section
        ...
        className="flex flex-col gap-5"
      >
        <h2 className="font-medium text-muted-foreground" id="size-md-heading">
          Size MD
        </h2>
        <div className="rounded-3xl bg-muted p-6 sm:p-10">
          <ExampleSizeMd />
      ...
      <section
        ...
        className="flex flex-col gap-5"
      >
        <h2 className="font-medium text-muted-foreground" id="size-sm-heading">
          Size SM
        </h2>
        <div className="rounded-3xl border bg-card p-6 sm:p-10">
          <ExampleSizeSm />
