...
const QuestionnaireAnimated = () => {
  ...
  return (
    ...
    >
      ...
      <QuestionnaireItem
        className="data-active:fade-in-0 data-active:slide-in-from-bottom-2 data-active:animate-in data-active:duration-300 motion-reduce:animate-none"
        name="task"
      >
