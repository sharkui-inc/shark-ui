  ...
  return (
    <ArkNavigationMenu.Trigger
      className={cn(
        ...
        menuItemControlVariants(),
        "w-full justify-between outline-hidden",
  ...
  return (
    <ArkNavigationMenu.Link
      className={cn(
        buttonControlVariants(),
        menuItemControlVariants(),
        "no-underline outline-hidden",
        "hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground",
        "data-highlighted:bg-accent data-highlighted:text-accent-foreground",
        "data-current:bg-accent data-current:font-medium data-current:text-accent-foreground",
        "focus-visible:border-ring/64 focus-visible:ring-2 focus-visible:ring-ring/24",
        "in-data-[slot=navigation-menu-content]:h-auto in-data-[slot=navigation-menu-content]:justify-start",
        "in-data-[slot=navigation-menu-content]:whitespace-normal",
        className
      )}
  ...
  return (
    <ArkNavigationMenu.Content
      className={cn(
        ...
        menuListVariants(),
        "rounded-xl text-popover-foreground outline-hidden",
        isViewportRendered
          ? "inset-s-0 top-0"
          : "inset-s-0 top-full mt-2 max-h-[70dvh] overflow-y-auto border bg-popover shadow-lg/4 data-[orientation=vertical]:inset-s-full data-[orientation=vertical]:top-0 data-[orientation=vertical]:ms-2 data-[orientation=vertical]:mt-0",
        ...
        "motion-reduce:data-[motion=from-start]:slide-in-from-start-0 motion-reduce:data-[motion=from-end]:slide-in-from-end-0 motion-reduce:data-[motion=to-start]:slide-out-to-start-0 motion-reduce:data-[motion=to-end]:slide-out-to-end-0",
        className
      )}
...
export const NavigationMenuIndicator = (
  ...
  return (
    <ArkNavigationMenu.Indicator
      className={cn(
        "absolute inset-s-(--trigger-x) bottom-0",
        "h-0.5 w-(--trigger-width)",
        "bg-primary",
        "rounded-full",
        "pointer-events-none",
        "transition-[inset-inline-start,top,width,height] duration-150 ease-in-out",
        "rtl:inset-s-[calc(100%-var(--trigger-x)-var(--trigger-width))]",
  ...
  return (
    <ArkNavigationMenu.ViewportPositioner
      className={cn(
        ...
        "absolute inset-e-0 inset-s-0 top-full",
        "flex justify-center",
        "pointer-events-none",
        "data-[orientation=vertical]:inset-e-auto data-[orientation=vertical]:inset-s-full data-[orientation=vertical]:top-0",
        className
      )}
  ...
  return (
    <ArkNavigationMenu.Viewport
      className={cn(
        ...
        "origin-top transition-[width,height] duration-150 ease-in-out",
