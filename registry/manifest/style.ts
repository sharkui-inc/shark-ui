...
const cssVars = {
  ...
  light: {
    ...
    muted: "color-mix(in srgb, var(--color-neutral-950) 8%, var(--background))",
    "muted-foreground":
    ...
    "code-highlight":
      "color-mix(in srgb, var(--color-neutral-950) 10%, var(--code))",
    radius: "0.5rem",
  ...
  dark: {
    ...
    "code-foreground": "var(--foreground)",
    "code-highlight":
      "color-mix(in srgb, var(--color-neutral-50) 10%, var(--code))",
    sidebar:
