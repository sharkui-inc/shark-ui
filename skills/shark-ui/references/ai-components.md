...
Chat UI is composed from these primitives. APIs live in `content/docs/ai-components/<name>.mdx` and `registry/react/examples/<name>/`. Which component to pick: [`choose.md`](choose.md).
