  ...
  <ThumbCard {...props}>
    <div className="flex w-full flex-col overflow-hidden rounded-xl border border-input bg-muted shadow-sm/4">
      <div className="flex items-center justify-between border-b px-2 py-1.5">
        <div className="h-2.5 w-24 rounded bg-muted-foreground/32" />
        <div className="h-2.5 w-10 rounded bg-muted-foreground/24" />
      </div>
      <div className="flex flex-col gap-1 p-1">
        ...
        <div className="flex h-5 items-center px-1.5">
          <div className="h-2 w-2/5 rounded bg-muted-foreground/24" />
        </div>
        <div className="flex h-5 items-center px-1.5">
