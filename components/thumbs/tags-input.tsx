...
export const TagsInputThumb = ({ ...props }: TagsInputThumbProps) => (
  <ThumbCard {...props}>
    <div className="flex min-h-8 w-full max-w-52 flex-wrap items-center gap-1 rounded-lg border border-input bg-muted p-1 pr-4 shadow-md/5">
      ...
      <XIcon aria-hidden className="ms-auto size-2 text-muted-foreground/64" />
    </div>
  </ThumbCard>
);
