...
export const PopoverThumb = (props: ThumbCardProps) => (
  <ThumbCard {...props}>
    <div className="flex w-48 flex-col items-center gap-2">
      <div className="flex w-full flex-col gap-2 rounded-lg border border-input border-dashed bg-muted p-2 shadow-sm/4">
      ...
      <div className="flex h-8 w-20 items-center justify-center gap-2 rounded-lg bg-primary shadow-sm/4">
