...
export const TextareaThumb = (props: ThumbCardProps) => (
  <ThumbCard {...props}>
    <div className="relative w-52 rounded-lg border border-input bg-muted shadow-md/5">
      ...
      <div className="absolute end-1.5 bottom-1 h-2 w-px rotate-45 bg-muted-foreground/32" />
      <div className="absolute end-1 bottom-1 h-1 w-px rotate-45 bg-muted-foreground/32" />
    </div>
  </ThumbCard>
);
