        ...
        >
          <span
            className={cn(
              "size-8 rounded-full",
              preset.swatchClass,
              "group-data-[state=checked]:ring-2 group-data-[state=checked]:ring-foreground/24 group-data-[state=checked]:ring-offset-2 group-data-[state=checked]:ring-offset-background"
            )}
          />
