---
title: Marquee
description: Scroll items in a horizontal strip.
seo:
  description: Horizontal scrolling strip for logos and highlights.
links:
  doc: https://ark-ui.com/docs/components/marquee
  api: https://ark-ui.com/docs/components/marquee#api-reference
---

import manifest from "@/registry/manifest/marquee";
...
<RTLComponentPreview componentName="marquee" />
...
Provides a Marquee API created with `useMarquee` to descendant components.
...
Public MarqueeEdge component. It forwards the underlying primitive props.
