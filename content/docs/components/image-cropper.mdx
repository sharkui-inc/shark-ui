...
| Prop | Type | Default |
| --- | --- | --- |
| `--cropper-accent` | CSS custom property | `var(--color-white)` |
| `--cropper-handler-size` | CSS custom property | `--spacing(2)` |
| `--cropper-handler-width` | CSS custom property | `--spacing(1)` |
