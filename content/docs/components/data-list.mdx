...
seo:
  description: Label and value pairs for metadata and detail panels.
---

import manifest from "@/registry/manifest/data-list";
...
<RTLComponentPreview componentName="data-list" />
