---
title: Field
description: Label, control, and helper text.
seo:
  description: Wraps label, control, and helper or error text.
links:
  doc: https://ark-ui.com/docs/components/field
  api: https://ark-ui.com/docs/components/field#api-reference
---

import manifest from "@/registry/manifest/field";
...
<RTLComponentPreview componentName="field" />
