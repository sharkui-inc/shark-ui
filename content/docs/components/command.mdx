...
seo:
  description: Command palette with filtering, groups, and shortcuts.
links:
  doc: https://ark-ui.com/docs/components/combobox
  api: https://ark-ui.com/docs/components/combobox#api-reference
---

import manifest from "@/registry/manifest/command";
...
Use the `disabled` prop to disable the entire command palette.

<ComponentPreview componentName="command" fileName="example-disabled" />

### Disabled Item

Set `disabled: true` on an item in the collection to disable a specific command.

<ComponentPreview componentName="command" fileName="example-disabled-item" />

## Variants

### Default

On mobile, the default variant is flush with the screen edge.

<ComponentPreview componentName="command" fileName="example-variant-default" />

### Inset

Use `variant="inset"` to give the command palette an inset from the screen edge.
...
Set `fill` to use the full available mobile viewport for the command dialog.

<ComponentPreview componentName="command" fileName="example-fill" />
...
<RTLComponentPreview componentName="command" />
...
Provides a Command API created with `useCommand` to descendant components.

| Prop | Type | Default |
| --- | --- | --- |
| `value` | `UseCommandReturn` | **required** |
