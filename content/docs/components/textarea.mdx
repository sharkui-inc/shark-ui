...
seo:
  description: Multi-line text field for longer notes and messages.
links:
  doc: https://ark-ui.com/docs/components/field#textarea
  api: https://ark-ui.com/docs/components/field#api-reference
---

import manifest from "@/registry/manifest/textarea";
...
<RTLComponentPreview componentName="textarea" />
