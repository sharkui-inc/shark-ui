---
title: Status
description: Color-coded process status.
seo:
  description: Color-coded status for process and lifecycle states.
---

import manifest from "@/registry/manifest/status";
...
<RTLComponentPreview componentName="status" />
