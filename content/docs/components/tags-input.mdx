---
title: Tags Input
description: Add and remove tags in a field.
seo:
  description: Type values that become removable tags in one field.
links:
  doc: https://ark-ui.com/docs/components/tags-input
  api: https://ark-ui.com/docs/components/tags-input#api-reference
---

import manifest from "@/registry/manifest/tags-input";
...
<RTLComponentPreview componentName="tags-input" />
...
Provides a TagsInput API created with `useTagsInput` to descendant components.

| Prop | Type | Default |
| --- | --- | --- |
| `value` | `UseTagsInputReturn` | **required** |
...
Public TagsInputControl component. It forwards the underlying primitive props.
...
Public TagsInputItemPreview component. It forwards the underlying primitive props.
...
Public TagsInputItemText component. It forwards the underlying primitive props.
...
Public TagsInputItemDeleteTrigger component. It forwards the underlying primitive props.
...
Public TagsInputItemInput component. It forwards the underlying primitive props.
...
- [Input Group](/docs/components/input-group) - input with inline addons
