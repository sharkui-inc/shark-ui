...
| Prop | Type | Default |
| --- | --- | --- |
| `--indentation` | CSS custom property | `--spacing(4)` |
| `--item-gap` | CSS custom property | `--spacing(2)` |
| `--padding-block` | CSS custom property | `--spacing(1.5)` |
| `--padding-inline` | CSS custom property | `--spacing(3)` |
| `--icon-size` | CSS custom property | `--spacing(4)` |
