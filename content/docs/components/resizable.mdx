---
title: Resizable
description: Split a layout into resizable panes.
seo:
  description: Split a layout into panes the user can drag to resize.
links:
  doc: https://ark-ui.com/docs/components/splitter
  api: https://ark-ui.com/docs/components/splitter#api-reference
---

import manifest from "@/registry/manifest/resizable";
...
<RTLComponentPreview componentName="resizable" />
...
Provides a Resizable API created with `useResizable` to descendant components.

| Prop | Type | Default |
| --- | --- | --- |
| `value` | `UseResizableReturn` | **required** |
