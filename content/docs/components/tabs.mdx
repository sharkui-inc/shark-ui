...
seo:
  description: Switch panels with tabs and keyboard support.
links:
  doc: https://ark-ui.com/docs/components/tabs
  api: https://ark-ui.com/docs/components/tabs#api-reference
---

import manifest from "@/registry/manifest/tabs";
...
<RTLComponentPreview componentName="tabs" />
...
Provides a Tabs API created with `useTabs` to descendant components.
