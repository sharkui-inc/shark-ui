...
Use `autoSubmit` to submit the owning form when every slot is filled. 
...
<RTLComponentPreview componentName="input-otp" />
...
Provides a InputOTP API created with `useInputOTP` to descendant components.

| Prop | Type | Default |
| --- | --- | --- |
| `value` | `UseInputOTPReturn` | `required` |
