...
- [Alert Dialog](/docs/components/alert-dialog) - interruptive confirmation dialog
- [Sheet](/docs/components/sheet) - edge-sliding panel for mobile-friendly layouts
- [Drawer](/docs/components/drawer) - swipeable sliding panel
- [Popover](/docs/components/popover) - non-modal anchored overlay
