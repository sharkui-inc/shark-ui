---
title: Link Overlay
description: Make a whole surface clickable.
seo:
  description: Stretch one link across a card so the whole surface is clickable.
---

import manifest from "@/registry/manifest/link-overlay";
...
<RTLComponentPreview componentName="link-overlay" />
