---
title: Separator  
description: Visual line that separates content.
seo:
  description: Horizontal or vertical rule to group content.
---

import manifest from "@/registry/manifest/separator";
...
<RTLComponentPreview componentName="separator" />
