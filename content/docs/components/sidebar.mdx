...
| Prop | Type | Default |
| --- | --- | --- |
| `--sidebar-width` | CSS custom property | `16rem` |
| `--sidebar-width-mobile` | CSS custom property | `18rem` |
| `--sidebar-width-icon` | CSS custom property | `3rem` |
...
| Prop | Type | Default |
| --- | --- | --- |
| `--fade-size` | CSS custom property | `3rem` |
