...
<PreviewIframe wide src="/view/blocks/sidebar/rtl" title="Sidebar RTL" className="min-h-[550px]" />
...
| `onOpenChange` | `(details: OpenChangeDetails) => void` | Fires when the open flag changes. |
...
| --- | --- | --- |
| `placement` | `"left" \| "right"` | Physical horizontal edge the column hugs; it does not change with document direction. |
