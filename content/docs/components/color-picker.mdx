---
title: Color Picker
description: Pick colors with hue and alpha.
seo:
  description: Pick colors with hue, alpha, and channel fields.
links:
  doc: https://ark-ui.com/docs/components/color-picker
  api: https://ark-ui.com/docs/components/color-picker#api-reference
---

import manifest from "@/registry/manifest/color-picker";
...
Use `value` and `onValueChange` to control the color picker.
...
Use `value` and `onValueChange` to control the swatch picker.
...
<RTLComponentPreview componentName="color-picker" fileName="example-input-rtl" />

### Popover

<RTLComponentPreview componentName="color-picker" fileName="example-popover-rtl" />

### Swatch Picker

<RTLComponentPreview componentName="color-picker" fileName="example-swatch-picker-rtl" />

### Area

<RTLComponentPreview componentName="color-picker" fileName="example-area-rtl" />

### Slider

<RTLComponentPreview componentName="color-picker" fileName="example-slider-rtl" />
...
Provides a ColorPicker API created with `useColorPicker` to descendant components.
