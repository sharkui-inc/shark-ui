...
<RTLComponentPreview componentName="color-picker" rtlFileName="example-input-rtl" />

### Popover

<RTLComponentPreview componentName="color-picker" rtlFileName="example-popover-rtl" />

### Swatch Picker

<RTLComponentPreview componentName="color-picker" rtlFileName="example-swatch-picker-rtl" />

### Area

<RTLComponentPreview componentName="color-picker" rtlFileName="example-area-rtl" />

### Slider

<RTLComponentPreview componentName="color-picker" rtlFileName="example-slider-rtl" />
