...
seo:
  description: Join related buttons into one control surface.
---

import manifest from "@/registry/manifest/button-group";
...
<RTLComponentPreview componentName="button-group" />
...
Public ButtonGroupText component. It forwards the underlying primitive props.
