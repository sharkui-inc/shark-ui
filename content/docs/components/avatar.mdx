---
title: Avatar
description: Profile image with fallback.
seo:
  description: Profile image with fallback initials and optional status.
links:
  doc: https://ark-ui.com/docs/components/avatar
  api: https://ark-ui.com/docs/components/avatar#api-reference
---

import manifest from "@/registry/manifest/avatar";
...
<RTLComponentPreview componentName="avatar" />
...
Provides a Avatar API created with `useAvatar` to descendant components.

| Prop | Type | Default |
| --- | --- | --- |
| `value` | `UseAvatarReturn` | `required` |
