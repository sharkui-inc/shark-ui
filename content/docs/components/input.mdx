...
seo:
  description: Text input with size variants and invalid styles.
links:
  doc: https://ark-ui.com/docs/components/field#input
  api: https://ark-ui.com/docs/components/field#api-reference
---

import manifest from "@/registry/manifest/input";
...
<RTLComponentPreview componentName="input" />
...
- [Password Input](/docs/components/password-input) - password field with show/hide
