---
title: Toast
description: Short-lived feedback on an action.
seo:
  description: Short-lived notifications for success, errors, and undo.
links:
  doc: https://ark-ui.com/docs/components/toast
  api: https://ark-ui.com/docs/components/toast#api-reference
---

import manifest from "@/registry/manifest/toast";
...
<RTLComponentPreview componentName="toast" />
...
Public ToastItem component. It forwards the underlying primitive props.
...
- [Alert](/docs/components/alert) - inline status banner
- [Alert Dialog](/docs/components/alert-dialog) - interruptive confirmation dialog
- [Announcement](/docs/components/announcement) - inline product notice
