...
seo:
  description: Countdown or stopwatch with start, pause, and reset.
links:
  doc: https://ark-ui.com/docs/components/timer
  api: https://ark-ui.com/docs/components/timer#api-reference
---

import manifest from "@/registry/manifest/timer";
...
<RTLComponentPreview componentName="timer" />
...
Visual delimiter between item groups.
...
Provides a Timer API created with `useTimer` to descendant components.
