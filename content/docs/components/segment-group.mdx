---
title: Segment Group
description: Segmented control for a choice.
seo:
  description: Segmented control that highlights the active choice.
links:
  doc: https://ark-ui.com/docs/components/segment-group
  api: https://ark-ui.com/docs/components/segment-group#api-reference
---

import manifest from "@/registry/manifest/segment-group";
...
<RTLComponentPreview componentName="segment-group" />
...
Provides a SegmentGroup API created with `useSegmentGroup` to descendant components.
