...
The `pill` prop creates fully rounded toggle groups. 

With `spacing={0}`, the group becomes a segmented pill control. With spacing, each item is individually pill-shaped.
