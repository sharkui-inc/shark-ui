...
<RTLComponentPreview componentName="date-picker" />
...
Wraps the calendar. Sets `--cell-size` for date cell sizing (same default as Calendar).
...
Provides a DatePicker API created with `useDatePicker` to descendant components.
