...
seo:
  description: "Input plus inline addons: icons, buttons, prefixes, and kbd hints."
---

import manifest from "@/registry/manifest/input-group";
...
Password field with visibility toggle, clear, and strength meter.
...
<RTLComponentPreview componentName="input-group" />
...
- [Field](/docs/components/field) - label, control, and helper shell
