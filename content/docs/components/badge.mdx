...
seo:
  description: Small chips for labels, counts, and status.
---

import manifest from "@/registry/manifest/badge";
...
<ComponentPreview componentName="badge" fileName="example-with-status" />
...
<RTLComponentPreview componentName="badge" />
