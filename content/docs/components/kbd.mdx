---
title: Kbd
description: Styled representation of a key.
seo:
  description: Keyboard key glyph for shortcuts and docs.
---

import manifest from "@/registry/manifest/kbd";
...
<RTLComponentPreview componentName="kbd" />
