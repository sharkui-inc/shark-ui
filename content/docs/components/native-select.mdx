---
title: Native Select
description: Styled native HTML select.
seo:
  description: Styled native select that keeps platform behavior.
---

import manifest from "@/registry/manifest/native-select";
...
- **NativeSelect**: use for native browser behavior, better performance, or mobile-optimized menus.
...
<RTLComponentPreview componentName="native-select" />
