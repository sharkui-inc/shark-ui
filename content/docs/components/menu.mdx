---
title: Menu
description: Dropdown menu of actions.
seo:
  description: Dropdown of actions from a button, including submenus.
links:
...
`value` on each `MenuTrigger`. `onTriggerValueChange` tracks which row opened the menu.

<ComponentPreview componentName="menu" fileName="example-multiple-triggers" />
...
Secondary line under a menu item label. Aligns leading icons to the title when present.
...
- [Button Group](/docs/components/button-group) - grouped related buttons
