---
title: Alert
description: Inline alert for user attention.
seo:
  description: Inline alert for info, success, warning, and destructive feedback.
---

import manifest from "@/registry/manifest/alert";
...
<RTLComponentPreview componentName="alert" />
