...
seo:
  description: Click-to-edit text that swaps read and edit modes.
links:
  doc: https://ark-ui.com/docs/components/editable
  api: https://ark-ui.com/docs/components/editable#api-reference
---

import manifest from "@/registry/manifest/editable";
...
Use `value` and `onValueChange` to control the editable.
...
<ComponentPreview componentName="editable" fileName="example-size-md" />
...
<RTLComponentPreview componentName="editable" />
...
Provides a Editable API created with `useEditable` to descendant components.
