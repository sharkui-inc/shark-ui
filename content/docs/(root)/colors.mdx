...
Floating surfaces and the content inside them, such as Popover, Menu, ContextMenu, and other overlays.
...
Series colors for Chart.

- <span className="inline-flex gap-1 mr-2 align-middle"><span className="inline-block size-8 rounded border border-border bg-chart-1" /></span> `--chart-1`
- <span className="inline-flex gap-1 mr-2 align-middle"><span className="inline-block size-8 rounded border border-border bg-chart-2" /></span> `--chart-2`
- <span className="inline-flex gap-1 mr-2 align-middle"><span className="inline-block size-8 rounded border border-border bg-chart-3" /></span> `--chart-3`
- <span className="inline-flex gap-1 mr-2 align-middle"><span className="inline-block size-8 rounded border border-border bg-chart-4" /></span> `--chart-4`
- <span className="inline-flex gap-1 mr-2 align-middle"><span className="inline-block size-8 rounded border border-border bg-chart-5" /></span> `--chart-5`
