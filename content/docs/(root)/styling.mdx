...
:root {
  ...
  --primary-hover: color-mix(in srgb, var(--color-neutral-800) 92%, var(--color-neutral-950));
  --secondary: color-mix(
    in srgb,
    var(--color-neutral-950) 8%,
    var(--background)
  );
  --secondary-foreground: var(--color-neutral-800);
  --secondary-hover: color-mix(in srgb, var(--color-neutral-950) 16%, var(--background));
  --muted: color-mix(in srgb, var(--color-neutral-950) 4%, var(--background));
  --muted-foreground: color-mix(
    in srgb,
    var(--color-neutral-500) 88%,
    var(--color-neutral-950)
  );
  --accent: color-mix(in srgb, var(--color-neutral-950) 8%, var(--background));
...
.dark {
  ...
  --primary-hover: color-mix(in srgb, var(--color-neutral-100) 92%, var(--color-neutral-950));
  --secondary: color-mix(in srgb, var(--color-neutral-50) 8%, var(--background));
  --secondary-foreground: var(--color-neutral-100);
  --secondary-hover: color-mix(in srgb, var(--color-neutral-50) 16%, var(--background));
...
@layer base {
  ...
  * {
    @apply border-border outline-ring ring-ring;
  }
...
Shark UI assigns radius by component type and visual weight:

- `rounded-sm` for compact controls: `Checkbox` and `Kbd`.
- `rounded-md` for supporting UI: `Badge` and `Skeleton`.
- `rounded-lg` for standard controls: `Button`, `Input`, `Textarea`, `Select`, `Tooltip`, and `Toast`.
- `rounded-xl` for contained surfaces: `Card`, `Menu`, `Popover`, and `HoverCard`.
- `rounded-2xl` for larger overlays: `Dialog`, `Sheet`, `Drawer`, `Command`, and `FloatingPanel`.
- `rounded-full` for circular UI and pills: `Avatar`, `Switch` and `Progress`.

Small controls use a smaller radius when needed. Nested parts inherit their container's radius so edges stay aligned.
