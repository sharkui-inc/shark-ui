...
Styling uses CSS variables for crisp borders and clear stacking. See [Colors](/docs/colors) for tokens and utility mapping. You can use your own palette, but the defaults are tuned for layered depth and clarity.
