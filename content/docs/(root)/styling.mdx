...
Styling uses CSS variables for crisp borders and clear stacking. See [Colors](/docs/colors) for tokens and utility mapping. 

## CSS Configuration

See [Installation](/docs/installation#new-project-setup) for setup. To add the theme yourself, paste the following into `globals.css`:
...
To customize colors interactively, use the [Themes](/themes) page: pick primary and gray bases, adjust border radius, preview light and dark, then copy the generated CSS variables into your `globals.css`.
