...
For new projects, you have the automatic setup with the CLI or use the framework-specific manual setup:
...
For theming, `globals.css`, and layout setup, see [Styling](/docs/styling). Colors use predefined variables from [Tailwind CSS](https://tailwindcss.com/docs/colors). 
